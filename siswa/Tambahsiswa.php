        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">Tambah Siswa SMKN 1 Ciomas</h1>

                <form action="">
                    <label for="nama" class="form-nama">Nama</label>
                    <input type="nama">
                    <br>
                    <label for="nisn" class="form-nama">NISN</label>
                    <input type="nisn">
                    <br>
                    <label for="email" class="form-nama">Email</label>
                    <input type="email">
                    <br>
                    <label for="jk" class="form-nama">Jenis Kelamin</label>
                 <input type="jk">
                </form>
<br>
